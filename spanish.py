...
#measuring
cap_sel = str(input("Ingrese capacitancia maxima a medir (en microfaradios) [1000] "))
...
print("3: 1k")
print("4: 576")
res_sel = str(input("Seleccione Resistencia (en ohms) ["+str(default_resistor+1)+"]"))
...
print("Por favor, seleccione la resistencia #"+str(default_resistor+1)+" de "+str(resistor)+" ohm.")
...
while True:
	...
	if nm1.is_valid() == True:
		...
		print("La capacitancia medida es:",capacitor * 10**6, "uF.")
	else:
		if GPIO.input(pin_detect) == True:
			print("La capacitancia medida esta por debajo de la medicion minima posible.")
		else:
			print("La capacitancia medida esta por encima de la medicion maxima posible.")
	#~ if nm1.is_valid() == True:
